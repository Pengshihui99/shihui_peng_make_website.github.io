...
* save this flex_dashboard file in our desktop
  ...
  * b/c in the repo, our rmd will create a html file when knitting, so things in this file will be overwritten by the _site.html
    * To address this issue, instead of knitting, we can use this command to knit the dashboard: **rmarkdown::render("dashboard.Rmd", output_format = "flexdashboard::flex_dashboard")**. Make sure the output_format is correct.
